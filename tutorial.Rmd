---
title: 'T-cell repertoire sequencing data analysis in R: part II'
author: 'Mikhail Shugay'
institute: 'Skolkovo Institute of Science and Technology'
date: "28 February 2019, MRC Weatherall Institute"
output:
...
p3 <- ggplot(df.mds.ag.freq %>% filter(!is.na(epi.name)),
